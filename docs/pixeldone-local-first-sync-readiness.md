...
- Supabase Postgres should store todos, checklists, and deletion tombstones. Theme and Dock preferences stay local-only.
...
- The first sync version should include tasks, checklists, and deletion tombstones.
