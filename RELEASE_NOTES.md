PixelDone v2.10.0-rc.2 is a beta release candidate for the local-first storage and optional Supabase cloud-sync path.
...
Install note: this prerelease asset is the debug RC APK, `PixelDone-2.10.0-rc.2-debug.apk`, for `com.milesxue.pixeldone.debug`. It installs separately from the formal signed app `com.milesxue.pixeldone`; the latest formal signed release remains v2.9.3.