PixelDone v2.7.4-rc.2 is a beta RC prerelease for custom dialog action alignment and Android 14+ full-screen intent permission flow fixes.
...
Install note: use the attached beta debug APK, `PixelDone-2.7.4-rc.2-debug.apk`, for PixelDone-beta testing. This build installs as `com.milesxue.pixeldone.debug`; uninstall incompatible older beta/debug builds only if Android reports a package or signature conflict.
