...
1. Confirm the Supabase migration verification output, Realtime publication, and daily cleanup cron.
...
4. Test two signed-in devices: todo/list changes, completion, Trash/restore, permanent deletion, language sync, Realtime foreground catch-up, token refresh, and conflict aggregation.
